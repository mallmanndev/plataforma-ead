...
const HOST_SERVICE_CORE = "service-core:3000"
...
const packageDefinition = protoLoader.loadSync(PROTO_PATH, PROTO_LOADER_CONFIGS);

const filesPackageDefinition = protoLoader.loadSync(FILES_PROTO_PATH, PROTO_LOADER_CONFIGS);

const coursesPackageDefinition = protoLoader.loadSync(COURSES_PROTO_PATH, PROTO_LOADER_CONFIGS);

export const UsersService = (grpc.loadPackageDefinition(packageDefinition) as any).UsersService;
export const usersService = new UsersService(HOST_SERVICE_CORE, grpc.credentials.createInsecure());
