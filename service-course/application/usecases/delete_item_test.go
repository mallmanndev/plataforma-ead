...
import (
	...
	"github.com/matheusvmallmann/plataforma-ead/service-course/tests/fixtures"
...
func TestDeleteItem(t *testing.T) {
	...
	t.Run("should_update_item_successfully", func(t *testing.T) {
		...
		item, section := course.FindItem("item_id_1")
